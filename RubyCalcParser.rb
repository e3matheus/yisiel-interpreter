...
module_eval <<'..end Parser.y modeval..id9e703daaa6', 'Parser.y', 227
...
..end Parser.y modeval..id9e703daaa6
...
module_eval <<'.,.,', 'Parser.y', 170
 ...
 result = ASTInvoca.new(val[0],val[2]); puts "invocar -> TkId(#{ val[0].value.to_s }) ( w ) \n"
   result
  end
.,.,
...
module_eval <<'.,.,', 'Parser.y', 197
 ...
 result = ASTLength.new(ASTId,new(val[1]));            puts "exp -> $ TkId(#{val[0].value.to_s})\n"
   result
  end
.,.,
